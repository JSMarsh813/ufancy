        ...
        >
          <div className="relative w-screen flex justify-center ">
            <img
              ...
              alt="123"
              loading="eager"
              className="lg:max-w-[400px] sm:max-w-[400px] max-w-[300px] mx-auto absolute z-10 rounded-xl custom-border-gray hero-dashboard-border-gradient pt-10 lg:top-6 xl:top-0"
            />
          </div>
        </motion.div>
        <div className="relative w-screen flex justify-center ">
